export function ProductSaleIcon({width, height}) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        ...
        className="fill-[#2F2E30] group-hover:fill-[#ebb8b8]"
      />
      <circle cx="40" cy="40" r="29" className="fill-[#2F2E30] group-hover:fill-white" />
      <path
