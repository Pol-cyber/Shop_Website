...
import { Elipse } from "../../../components/svgIcon/elipse";
...
export function RecommendBoard({ className }) {
  ...
  return (
    ...
    >
      ...
      <TabSwitcher list={advertiseData} indexCurrentItem={indexCurrentItem} setIndexCurrentitem={setIndexCurrentitem}></TabSwitcher>
    </div>
  );
}
