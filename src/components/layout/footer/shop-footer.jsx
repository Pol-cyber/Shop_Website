export function ShopFooter() {
  return (
    <footer className="text-white w-full h-[340px] bg-black">
      <div className="mx-[135px] py-[60px] flex justify-between">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                <img
                  ...
                  src="./footer/qrCod.png"
                ></img>
                <div className="flex flex-col gap-1">
                  <div className="py-[5px] px-[3px]">
                    <img
                      className="w-[104px] h-[30px] rounded-[4px]"
                      src="./footer/googlePlay.png"
                    ></img>
                  </div>
                  <div className="py-[3px] px-[2px]">
                    <img
                      className="w-[108px] rounded-[4px] h-[34px]"
          ...
          <div className="flex gap-6">
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clipPath="url(#clip0_1848_3889)">
                <path
